        ...
        public IntroductionPage()
        {
            ...
            Label description = new Label
            {
                Text = "This app wants to inspire you for neural networks!\n\n"+
                    ...
                    "How to use this app? It comes with the MNIST data base including pixel data of handwritten digits for training and testing purpose. So you just have to do the following two steps:\n\n"+
                    "Step 1: Train the neural net\n\n"+
                    "Just touch the according menu item and select the number of data sets you want to use for training. The more digits you teach, the better your net will perform.\n\n"+
