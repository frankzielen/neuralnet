        ...
        public IntroductionPage()
        {
            ...
            Label description = new Label
            {
                Text = "This app wants to inspire you for neural networks!\n\n"+
                    ...
                    "Select the test menu. You may either do a mass testing with the MNIST test data (just choose again the number of data sets to use) or you prove the net with your own handwritten figures. Just take a picture of a digit and the trained net will hopefully give the right answer!\n\n"+
